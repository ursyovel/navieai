...
import { MessageSquare, Volume2, Zap, History, Users, Brain, Shield, Star, Bot, Lock, Sparkles, Clock } from 'lucide-react';
    ...
    <div className="min-h-screen">
          ...
          >
            <div className={`rounded-xl shadow-2xl overflow-hidden ${theme === 'dark' ? 'bg-gray-900' : 'bg-white'}`}>
              ...
              <div className="p-4 space-y-4">
                ...
                <div className="flex justify-start">
                  <div className="bg-gray-100 dark:bg-gray-800 p-3 rounded-lg rounded-tl-none max-w-[80%]">
                    <p className="text-gray-800 dark:text-gray-200">I'm Navie AI, a simple chatbot designed to assist you with information, tasks, and conversations. I can help answer questions, remember context, and even support voice interactions. What would you like to know?</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className="py-16 bg-gradient-to-r from-purple-600 to-pink-500">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl font-bold text-white mb-4">Ready to Experience Navie AI?</h2>
          <p className="text-xl text-white/90 mb-8 max-w-2xl mx-auto">
            Join thousands of users who are already enhancing their productivity and getting answers instantly with Navie AI.
          </p>
          <motion.button
            whileHover={{ scale: 1.05 }}
            whileTap={{ scale: 0.95 }}
      ...
      {/* Footer */}
      <footer className="py-10 bg-gray-100 dark:bg-gray-900 border-t dark:border-gray-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <p className="text-gray-600 dark:text-gray-400">
            Navie AI • a simple chatbot • {new Date().getFullYear()}
          </p>
        </div>
      </footer>
    </div>
